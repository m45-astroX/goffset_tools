...
b_gaussfit='qdpFit_v1.0.bash'

# check files
if [ ! -e ${d_bin}/$b_gaussfit ] ; then
    echo "${b_gaussfit} does not exist..."
    exit
fi
...
# fit
bash ${d_bin}/$b_gaussfit $inputFile $MAX_PHA $MAX_cnt $L_PHA $R_PHA > /dev/null
