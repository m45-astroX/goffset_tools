...
for SEGMENT in ${SEGMENT_list[@]} ; do
    ...
    $CONSGAUSS_FIT $outfile_spec_PHASSUM $PHASSUM_MIN $PHASSUM_MAX $color $outfile_figure_ps_PHASSUM > $tmp_fitresult
    ...
    for GRADE in ${GRADE_list[@]} ; do
        ...
        $CONSGAUSS_FIT $outfile_spec_PHA $PHA_MIN $PHA_MAX $color $outfile_figure_ps_PHA > $tmp_fitresult
